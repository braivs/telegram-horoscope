export const getHoroscope = async (
  ...
  const horoscopes = {
    ...
    ru: {
      ...
      libra: "Только если вы сами этого добьётесь. Звёзды ни при чём.",
      ...
      capricorn: "Труд окупится — звёзды тут ни при чём.",
      aquarius: "Ваша уникальность не в звёздах, а в ваших поступках.",
      pisces: "Звёзды молчат сегодня. Ваш выбор — нет.",
    },
  };
